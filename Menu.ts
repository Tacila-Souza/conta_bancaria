...
export function main() {
    ...
    while (true) {
        ...
        switch (opcao) {
            ...
            case 3:
                console.log(colors.fg.whitestrong, "n\nConsultar dados da Conta - por numero\n\n"
                , colors.reset);
...
function sobre(): void {
    console.log("\n*****************************************************");
    console.log("Projeto Desenvolvido por: Tacila Souza ");
    console.log("Generation Brasil - tacilasouza.contato@gmail.com");
    console.log("https://github.com/Tacila-Souza/conta_bancaria");
    console.log("*****************************************************");
}
